                ...
                <div class="col-lg-9">
                    <div class="bg-white rounded shadow p-4">
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            <h2 class="fs-4 fw-semibold mb-0">Available Quizzes</h2>
                            <div class="d-flex gap-2">
                                <div class="input-group">
                                    <span class="input-group-text bg-white border-end-0">
                                        <i class="ri-search-line"></i>
                                    </span>
                                    <input type="text" class="form-control border-start-0" placeholder="Search quizzes...">
                                </div>
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-6">
                                <div class="border rounded p-4 h-100">
                                    <div class="d-flex justify-content-between mb-3">
                                        ...
                                        <span class="text-secondary">30 mins</span>
                                    </div>
                                    <h3 class="fs-5 fw-semibold mb-3">Advanced Calculus Quiz</h3>
                                    <p class="text-secondary mb-4">Test your knowledge of derivatives, integrals, and differential equations.</p>
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="text-secondary">
                                            <i class="ri-question-line me-1"></i>
                                            20 Questions
                                        </div>
                                        <button class="btn btn-primary !rounded-button">Start Quiz</button>
                                    </div>
                                </div>
                            </div>
                            <!-- Quiz Card 2 -->
                            <div class="col-md-6">
                                <div class="border rounded p-4 h-100">
                                    <div class="d-flex justify-content-between mb-3">
                                        <span class="badge bg-primary bg-opacity-10 text-primary">Science</span>
                                        <span class="text-secondary">45 mins</span>
                                    </div>
                                    <h3 class="fs-5 fw-semibold mb-3">Physics Fundamentals</h3>
                                    <p class="text-secondary mb-4">Explore basic concepts of mechanics, energy, and motion.</p>
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="text-secondary">
                                            <i class="ri-question-line me-1"></i>
                                            25 Questions
                            ...
                            <div class="col-md-6">
                                <div class="border rounded p-4 h-100">
                                    <div class="d-flex justify-content-between mb-3">
                                        <span class="badge bg-primary bg-opacity-10 text-primary">Language</span>
                                        <span class="text-secondary">20 mins</span>
                                    </div>
                                    <h3 class="fs-5 fw-semibold mb-3">English Grammar Challenge</h3>
                                    <p class="text-secondary mb-4">Master advanced grammar rules and sentence structures.</p>
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="text-secondary">
                                            <i class="ri-question-line me-1"></i>
                                            15 Questions
                            ...
                            <div class="col-md-6">
                                <div class="border rounded p-4 h-100">
                                    <div class="d-flex justify-content-between mb-3">
                                        <span class="badge bg-primary bg-opacity-10 text-primary">Science</span>
                                        <span class="text-secondary">35 mins</span>
                                    </div>
                                    <h3 class="fs-5 fw-semibold mb-3">Chemistry Basics</h3>
                                    <p class="text-secondary mb-4">Learn about atomic structure, chemical bonds, and reactions.</p>
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="text-secondary">
                                            <i class="ri-question-line me-1"></i>
                                            22 Questions
